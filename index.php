...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom container-fluid">
        <div class="container">
            ...
            <a class="navbar-toggler" href="index.php" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $isEmpty ? 'disabled' : ''; ?>"
                            href="<?php echo $isEmpty ? '#' : 'book_appointment1.php'; ?>">Book
                            Appointment</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-flex add-white-bg">
            <div class="welcome-container container">
                <div class="left-content">
                    ...
                    <div class="sub-text">Take this opportunity to have the brows and natural pinkish youthful lips you
                        have always wanted!</div>
                    <div class="button-appoint mt-0">
                        <button type="button" class="btn btn-primary btn-primary-custom book-now"
                            onclick="window.location.href='book_appointment1.php'"
                            <?php echo $isEmpty ? 'disabled' : ''; ?>>BOOK NOW</button>
                    </div>
                </div>
                <img src="./assets/images/pictures/face.svg" id="microblading2" alt="First Image"
                    class="right-content">
            </div>
        </div>
                            ...
                            if ($row['service_state'] == 'Activated') {
                                ...
                                <div class="grid-item">
                                    ...
                                    <img class="grid-image"
                                        src='image.php?service_id=<?php echo $service_id; ?>'
                                        alt='Service Image'>
                                    <div class="description-text" id="text_service"><?php echo $service_description; ?></div>
                                    <button type="button" id="read_button_<?php echo $service_id; ?>"
                                        class="btn read-button mt-4 ml-4"
        ...
        <div class="container-flex add-white-bg">
            <div class="container">
                ...
                <div class="people-container">
                    <!-- left position -->
                    <img src="./assets/images/pictures/microblading2.jpg" id="people-choice" alt="People Choice"
                        class="circle-pic">
                    <!-- right position -->
                    <div class="pc-desc-container">
                        <div class="sub-text">Our Microblading and Lip Tattoo Service is availed by more than a
                            hundred clients! Book now and be one to experience this!</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-flex add-white-bg">
            <div class="container">
                <div class="people-container" id="about_us_section">
                    <!-- left position -->
                    <img src="./assets/images/pictures/browlesque.svg" id="browlesque-img" alt="Browlesque Image"
                        class="about-us-img">
                    <!-- right position -->
                    <div class="about-us-text">
                        <h1 class="mt-2 abt-center" id="about_label">About Us</h1>
                        <div class="sub-text sub-text-m">The Hollywood celebrities and star's choices for best
                            Microblading eyebrows, scalp and other micropigmentation procedures.<br><br>Take this
                            opportunity to have the brows and natural pinkish youthful lips you have always wanted!</div>
                        <div class="sub-text sub-text-m mt-0 add-bold"><br>Located at 12 Real Street Bacoor, Cavite,
                            Philippines.</div>
                    </div>
                </div>
            </div>
